...
* el portafoli personal

== Vídeo del projecte

El vídeo de demostració del projecte es troba disponible a la carpeta següent:

https://drive.google.com/drive/folders/1eGIqHTzie56mSDsBf0zltAEYAmXySKRk?usp=sharing
...
| GitHub
| https://github.com/XxericdlxX/XxericdlxX
|===
| Curs
| 2DAM
