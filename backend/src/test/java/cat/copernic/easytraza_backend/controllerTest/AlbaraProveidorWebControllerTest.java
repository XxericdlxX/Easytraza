...
import cat.copernic.easytraza_backend.controller.AlbaraProveidorWebController;
...
/**
 * Tests bàsics del controlador AlbaraProveidorWebController.
 */
class AlbaraProveidorWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                AlbaraProveidorWebController.class.isAnnotationPresent(Controller.class),
                "AlbaraProveidorWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(AlbaraProveidorWebController.class) || teAlgunMetodeAmbMapping(AlbaraProveidorWebController.class),
                "AlbaraProveidorWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
