...
import cat.copernic.easytraza_backend.controller.AlbaraClientWebController;
...
/**
 * Tests bàsics del controlador AlbaraClientWebController.
 */
class AlbaraClientWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                AlbaraClientWebController.class.isAnnotationPresent(Controller.class),
                "AlbaraClientWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(AlbaraClientWebController.class) || teAlgunMetodeAmbMapping(AlbaraClientWebController.class),
                "AlbaraClientWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
