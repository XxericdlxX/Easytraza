...
import cat.copernic.easytraza_backend.controller.mobileapi.OcrAlbaraMobileApiController;
...
/**
 * Tests bàsics del controlador OcrAlbaraMobileApiController.
 */
class OcrAlbaraMobileApiControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                OcrAlbaraMobileApiController.class.isAnnotationPresent(RestController.class),
                "OcrAlbaraMobileApiController ha de tenir @RestController"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(OcrAlbaraMobileApiController.class) || teAlgunMetodeAmbMapping(OcrAlbaraMobileApiController.class),
                "OcrAlbaraMobileApiController ha de definir rutes amb annotations de Spring MVC"
        );
    }
