...
import cat.copernic.easytraza_backend.controller.ProduccioLotsWebController;
...
/**
 * Tests bàsics del controlador ProduccioLotsWebController.
 */
class ProduccioLotsWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                ProduccioLotsWebController.class.isAnnotationPresent(Controller.class),
                "ProduccioLotsWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(ProduccioLotsWebController.class) || teAlgunMetodeAmbMapping(ProduccioLotsWebController.class),
                "ProduccioLotsWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
