...
import cat.copernic.easytraza_backend.controller.ComandaWebController;
...
/**
 * Tests bàsics del controlador ComandaWebController.
 */
class ComandaWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                ComandaWebController.class.isAnnotationPresent(Controller.class),
                "ComandaWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(ComandaWebController.class) || teAlgunMetodeAmbMapping(ComandaWebController.class),
                "ComandaWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
