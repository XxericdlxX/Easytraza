...
import cat.copernic.easytraza_backend.controller.GraficProductesVenutsWebController;
...
/**
 * Tests bàsics del controlador GraficProductesVenutsWebController.
 */
class GraficProductesVenutsWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                GraficProductesVenutsWebController.class.isAnnotationPresent(Controller.class),
                "GraficProductesVenutsWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(GraficProductesVenutsWebController.class) || teAlgunMetodeAmbMapping(GraficProductesVenutsWebController.class),
                "GraficProductesVenutsWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
