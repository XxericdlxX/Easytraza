...
import cat.copernic.easytraza_backend.controller.RecuperacioContrasenyaWebController;
...
/**
 * Tests bàsics del controlador RecuperacioContrasenyaWebController.
 */
class RecuperacioContrasenyaWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                RecuperacioContrasenyaWebController.class.isAnnotationPresent(Controller.class),
                "RecuperacioContrasenyaWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(RecuperacioContrasenyaWebController.class) || teAlgunMetodeAmbMapping(RecuperacioContrasenyaWebController.class),
                "RecuperacioContrasenyaWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
