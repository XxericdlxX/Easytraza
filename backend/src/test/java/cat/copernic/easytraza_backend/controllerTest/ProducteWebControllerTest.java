...
import cat.copernic.easytraza_backend.controller.ProducteWebController;
...
/**
 * Tests bàsics del controlador ProducteWebController.
 */
class ProducteWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                ProducteWebController.class.isAnnotationPresent(Controller.class),
                "ProducteWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(ProducteWebController.class) || teAlgunMetodeAmbMapping(ProducteWebController.class),
                "ProducteWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
