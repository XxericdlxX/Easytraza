...
import cat.copernic.easytraza_backend.controller.MateriaPrimaWebController;
...
/**
 * Tests bàsics del controlador MateriaPrimaWebController.
 */
class MateriaPrimaWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                MateriaPrimaWebController.class.isAnnotationPresent(Controller.class),
                "MateriaPrimaWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(MateriaPrimaWebController.class) || teAlgunMetodeAmbMapping(MateriaPrimaWebController.class),
                "MateriaPrimaWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
