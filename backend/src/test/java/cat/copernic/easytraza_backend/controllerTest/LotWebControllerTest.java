...
import cat.copernic.easytraza_backend.controller.LotWebController;
...
/**
 * Tests bàsics del controlador LotWebController.
 */
class LotWebControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                LotWebController.class.isAnnotationPresent(Controller.class),
                "LotWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(LotWebController.class) || teAlgunMetodeAmbMapping(LotWebController.class),
                "LotWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
