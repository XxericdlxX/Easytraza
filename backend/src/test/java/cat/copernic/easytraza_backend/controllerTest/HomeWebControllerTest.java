...
import cat.copernic.easytraza_backend.controller.HomeWebController;
...
/**
 * Tests bàsics del controlador HomeWebController.
 */
class HomeWebControllerTest {
    ...
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                HomeWebController.class.isAnnotationPresent(Controller.class),
                "HomeWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(HomeWebController.class) || teAlgunMetodeAmbMapping(HomeWebController.class),
                "HomeWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
