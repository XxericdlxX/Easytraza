...
import cat.copernic.easytraza_backend.controller.mobileapi.MobileLotsApiController;
...
/**
 * Tests bàsics del controlador MobileLotsApiController.
 */
class MobileLotsApiControllerTest {

    @Test
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                MobileLotsApiController.class.isAnnotationPresent(RestController.class),
                "MobileLotsApiController ha de tenir @RestController"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(MobileLotsApiController.class) || teAlgunMetodeAmbMapping(MobileLotsApiController.class),
                "MobileLotsApiController ha de definir rutes amb annotations de Spring MVC"
        );
    }
