...
import cat.copernic.easytraza_backend.controller.AuthWebController;
...
/**
 * Tests bàsics del controlador AuthWebController.
 */
class AuthWebControllerTest {
    ...
    void controladorTeAnotacioSpringCorrecta() {
        assertTrue(
                AuthWebController.class.isAnnotationPresent(Controller.class),
                "AuthWebController ha de tenir @Controller"
        );
    }
    ...
    void controladorDefineixAlgunaRuta() {
        assertTrue(
                teMappingDeClasse(AuthWebController.class) || teAlgunMetodeAmbMapping(AuthWebController.class),
                "AuthWebController ha de definir rutes amb annotations de Spring MVC"
        );
    }
