...
/**
 * Tests bàsics del servei GraficProductesVenutsService.
 */
class GraficProductesVenutsServiceTest {

    @Test
    void serveiTeAnotacioService() {
        assertTrue(
                GraficProductesVenutsService.class.isAnnotationPresent(Service.class),
                "GraficProductesVenutsService ha de tenir @Service"
        );
    }
    ...
    void serveiTeMetodesPublicsDeNegoci() {
        assertTrue(
                teAlgunMetodePublicDeNegoci(GraficProductesVenutsService.class),
                "GraficProductesVenutsService ha de tenir com a mínim un mètode públic de negoci"
        );
    }
